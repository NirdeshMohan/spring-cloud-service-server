...
* The original package name 'com.ishnit.microservice.spring-cloud-service-server' is invalid and this project uses 'com.ishnit.microservice.springcloudserviceserver' instead.
